...
int result = j.processCop(user,status);
j.connClose();
	if(result==1){
	response.sendRedirect("cops_auth.jsp?msg=Successfully Processed");
	}
	else{
	response.sendRedirect("cops_auth.jsp?msg=Try again later");
	}
%>
<%
		}
